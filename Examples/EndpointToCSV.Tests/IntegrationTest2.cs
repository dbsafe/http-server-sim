...
public class IntegrationTest2
{
    ...
    public void Initialize()
    {
        ...
        testHost = new HttpServerSimHost(simulatorUrl, testDirectory, "http-server-sim", $"--Rules rules.json --DefaultStatusCode 404 --Logging:LogLevel:HttpServerSim Debug --Logging:LogLevel:Microsoft.AspNetCore Warning");
    ...
    {
        // At this point http-server-sim must be running started by the test
